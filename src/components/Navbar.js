                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" href="nav" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Dropdown
                                </a>
                            ...
                            <li className="nav-item">
                                <a className="nav-link disabled" href='nav'>Disabled</a>
                            </li>
                        </ul>
